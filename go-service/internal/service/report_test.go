...
func TestReportService_GenerateStudentReport(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// Create service
			cfg := &config.Config{}
			service := NewReportService(mockNodeClient, mockPDFGen, cfg)

			// Execute
			result, err := service.GenerateStudentReport(tt.studentID, tt.generatedBy)
...
func TestReportService_HealthCheck(t *testing.T) {
	tests := []struct {
		name            string
		setupMocks      func(*MockNodeJSClient, *MockPDFGenerator)
...
func TestReportService_CleanupOldReports(t *testing.T) {
	tests := []struct {
		name          string
...
func TestReportService_GetAllStudents(t *testing.T) {
